            ...
            $.ajax({
                ...
                success: function (resp) {
                    if (resp.code=="1"){
                        ...
                        let htmlStr=""
                        $.each(resp.reData,function (i,n) {
                            htmlStr+="<tr id='tr_"+n.id+"'>"
                            htmlStr+="<td>"+n.name+"</td>"
                            htmlStr+="<td>"+n.startDate+"</td>"
                            htmlStr+="<td>"+n.endDate+"</td>"
                            htmlStr+="<td>"+n.owner+"</td>"
                            htmlStr+="<td><a href=\"javascript:void(0);\" activityId=\""+n.id+"\"  style=\"text-decoration: none;\"><span class=\"glyphicon glyphicon-remove\"></span>解除关联</a></td>"
                            htmlStr+="</tr>"
                        })
                        $("#tBody2").append(htmlStr)
                    }else{
                        alert(resp.message)
                    }
                }
