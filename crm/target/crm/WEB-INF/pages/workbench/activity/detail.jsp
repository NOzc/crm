            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.code=="1"){
                        $("#remark").val("");
                        let htmlStr="";
                        htmlStr+="<div id='div_"+data.reData.id+"' class=\"remarkDiv\" style=\"height: 60px;\">"
                        htmlStr+="<img title=\"${sessionScope.sessionUser.name}}\" src=\"image/user-thumbnail.png\" style=\"width: 30px; height:30px;\">"
                        htmlStr+="<div style=\"position: relative; top: -40px; left: 40px;\" >"
                        htmlStr+="<h5>"+data.reData.noteContent+"</h5>"
                        htmlStr+="<font color=\"gray\">市场活动</font> <font color=\"gray\">-</font> <b>${activity.name}</b> <small style=\"color: gray;\"> "+data.reData.createTime+" 由${sessionScope.sessionUser.name}创建</small>"
                        htmlStr+="<div style=\"position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;\">"
                        htmlStr+="<a class=\"myHref\" name='editA' remarkId=\""+data.reData.id+"\" href=\"javascript:void(0);\"><span class=\"glyphicon glyphicon-edit\" style=\"font-size: 20px; color: #E6E6E6;\"></span></a>"
                        htmlStr+="&nbsp;&nbsp;&nbsp;&nbsp;"
                        htmlStr+="<a class=\"myHref\" name='deleteA' remarkId=\""+data.reData.id+"\" href=\"javascript:void(0);\"><span class=\"glyphicon glyphicon-remove\" style=\"font-size: 20px; color: #E6E6E6;\"></span></a>"
                        htmlStr+="</div>"
                        htmlStr+="</div>"
                        htmlStr+="</div>"
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.code=="1"){
                        ...
                        $("#div_"+id+" h5").text(res.reData.noteContent)
                        $("#div_"+id+" small").text(" "+res.reData.editTime+" 由${sessionScope.sessionUser.name}修改")
                    }else {
                        alert(res.message);
                    }
                }
        ...
        <c:forEach items="${remarkList}" var="remark">
            <div id="div_${remark.id}" class="remarkDiv" style="height: 60px;">
                ...
                <div style="position: relative; top: -40px; left: 40px;" >
                    ...
                    <font color="gray">市场活动</font> <font color="gray">-</font> <b>${activity.name}</b> <small style="color: gray;"> ${remark.editFlag=='1'?remark.editTime:remark.createTime} 由${remark.editFlag=='1'?remark.editBy:remark.createBy}${remark.editFlag=='0'?'创建':'修改'}</small>
